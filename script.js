  ...
  const quizContent = `
    <form id="quiz-form">
      ...
      <section id="section-3">
        ...
        <fieldset>
          <legend>g) Jepen bazat e ADN A; T; G; A. Si do të jetë renditja e bazave në antikodonin e t-ARN? </legend>
        ...
        <fieldset>
          <legend>j) Qeliza diploide tek elefantet kanë 56 kromozome. Sa kromozome autosome janë në një gamet? </legend>
    ...
    if (submitBtn) {
      submitBtn.addEventListener("click", function () {
        ...
        const keySection2 = `
          ...
          <p><em>Shënim: Për përgjigjet e hapura, do të kontrollohen ne flete zgjidhja .</em></p>
        `;
        const keySection3 = `
